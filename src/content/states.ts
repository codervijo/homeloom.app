// US states + DC. Names/abbreviations/slugs are facts (not legal claims).
// All state-specific REGULATORY detail lives in the page template as
// [VERIFY: ...] placeholders — never fabricate law here.
export type StateInfo = { slug: string; name: string; abbr: string };
...
export function findState(slug: string | undefined): StateInfo | undefined {
